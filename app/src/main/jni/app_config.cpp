...
std::string SERVER_URL ="https://www.tutorial.hadashacloths.com"; //Copy API SERVER URL From Admin Panal->API Setting And Paste Here
std::string API_KEY = "5xqNJUDp6ZMjGoPu"; //Copy API KEY From Admin Panal->API Setting And Paste Here
